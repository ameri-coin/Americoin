...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Americoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"82.223.16.240:10319", "82.223.16.240:10319"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Americoin is probably already running."), addrBind.ToString().c_str());
        else
